...
const productDescOrbea = `Take it too far Partout, on peut trouver des avantages en termes de performances, de petites améliorations 
pour les grands vélos, et oui, un peu de bessoin en fait partie. Mais jusqu'où est-ce que c'est trop loin ? Les objectifs d'Orbea, ses 
concurrents et son attitude créative la poussent toujours vers la victoire. Et une fois que l'on connaît le goût sucré du succès, on en 
veut toujours plus. Il devient obsédé par l'idée d'être le meilleur. Tu le sens dans ton cœur, dans tes poumons, dans tes jambes - et tu
 le reconnais à nos roues. Ce n'est qu'en perfectionnant toujours plus les plus petits détails et en laissant derrière nous les limites de 
 ce qui semble réalisable qu'ils pourront atteindre leurs grands objectifs.
...
const productDescHaibike = 
`sphalte ou tout-terrain ? Avec le nouveau HardSeven 5, vous n'avez pas à vous décider ! Parce que c'est un eMTB polyvalent et agile. 
Avec un débattement de 120 mm, des freins à disque percutants, des roues 27,5 agiles et le puissant moteur Bosch Performance Line avec 
batterie intégrée de 500 Wh, vous vous amuserez beaucoup sur la route et en dehors. En route pour de nouvelles aventures !`
